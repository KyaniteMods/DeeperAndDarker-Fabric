...
public class OthersideBiomes {
    ...
    public static void createBiomes() {
        Registry.register(BuiltinRegistries.BIOME, OTHERSIDE_DEEPLANDS.location(), deeplands());
        Registry.register(BuiltinRegistries.BIOME, ECHOING_FOREST.location(), forest());
    }
