...
public class DDBlockTagsProvider extends FabricTagProvider<Block> {
    ...
    protected void generateTags() {
        tag(BlockTags.MINEABLE_WITH_HOE).add(DDBlocks.ECHO_LEAVES, DDBlocks.SCULK_GLEAM, DDBlocks.SCULK_VINES, DDBlocks.SCULK_VINES_PLANT, DDBlocks.INFESTED_SCULK, DDBlocks.SCULK_JAW);
        ...
        tag(BlockTags.SCULK_REPLACEABLE).add(Blocks.MOSS_BLOCK, DDBlocks.INFESTED_SCULK, DDBlocks.SCULK_JAW).addTag(BlockTags.LEAVES);
